...
public class BannerController {
	...
	public ModelAndView forwardAddBanner() {
		...
		mav.addObject("memberID", "kevin@ubn.net");
	...
	public ModelAndView saveBanner(HttpServletRequest request,@ModelAttribute("ad") Ad ad) {
	...
	public ModelAndView queryUploadAdBanner() {
