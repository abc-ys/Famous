...
<script>
function query(){
     document.fm.action="${pageContext.request.contextPath}/hiddenedAlbum.do";
     document.fm.submit();
}
function noHidden(Id){
    document.fm.action="${pageContext.request.contextPath}/noHiddened.do?ID="+Id;
    document.fm.submit();
}
function yesHidden(Id){
    document.fm.action="${pageContext.request.contextPath}/yesHiddened.do?ID="+Id;
    document.fm.submit();
}
