...
<script>
function query(){
    document.fm.action="${pageContext.request.contextPath}/queryHiddenSong.do";
    document.fm.submit();
}
function noHiddenSong(Id){
   document.fm.action="${pageContext.request.contextPath}/noHiddenSong.do?ID="+Id;
   document.fm.submit();
}
function yesHiddenSong(Id){
   document.fm.action="${pageContext.request.contextPath}/yesHiddenSong.do?ID="+Id;
   document.fm.submit();
}
